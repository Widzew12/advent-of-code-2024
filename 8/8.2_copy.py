...
def run():
    ...
    indexes = get_indexes_of_character(input_data, "h")
    print(indexes)
    antinode_indexes = get_antinode_indexes((0, 2), (2, 3), max_x, max_y)
    print(antinode_indexes)
        ...
        for letter_index_1 in letter_indexes:
            for letter_index_2 in letter_indexes:
                if letter_index_1 != letter_index_2:
                    antinode_indexes = get_antinode_indexes(letter_index_1, letter_index_2, max_x, max_y)
                    for index in antinode_indexes:
