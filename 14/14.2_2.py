...
def display_robots(robots_dict, num):
    ...
    for line in robots_map:
        ...
        #print(output_line)
    save_robots_to_file(output_list, num)

def save_robots_to_file(robots_list, num):
    output = ""
    for line in robots_list:
        #print(line)
        output += line + "\n"
    print(output)
    text_to_image.encode(output, f"output/img_{num}.png")
